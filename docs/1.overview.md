...
Every synapse integrates with [pipz](https://github.com/zoobz-io/pipz) for production-grade reliability:
...
All synapses emit [capitan](https://github.com/zoobz-io/capitan) hooks for observability:
...
- [Guides](./3.guides/1.installation.md) - Practical implementation patterns
- [Cookbook](./4.cookbook/1.classification-workflows.md) - Real-world recipes
- [Reference](./5.reference/1.cheatsheet.md) - Complete API documentation
