...
zyn emits [capitan](https://github.com/zoobz-io/capitan) hooks for full visibility into LLM interactions.
...
- [capitan Documentation](https://github.com/zoobz-io/capitan) - Full hooks reference
